...
/**  
 * @Title: EntityToMap.java
 * @Package com.qb.loan.admin.common.utils
...
public class EntityToMap {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EntityToMap.class);
