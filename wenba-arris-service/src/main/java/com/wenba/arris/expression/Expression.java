...
import com.wenba.arris.expression.syntax.SyntaxAnalyzer;
...
import com.wenba.arris.expression.tokens.TokenType;
...
public class Expression {
	...
	public List<Valuable> getFinalResult() {
		return finalResult;
	}
	 ...
	 */
	public List<Valuable> evaluate() throws SyntaxException {
		if(this.tokens == null) 
			throw new RuntimeException("The 'tokens' is null, Please go for lexical analysis by invoking 'lexicalAnalysis()' first.");
	 ...
	 * @throws SyntaxException 语法错误异常
	 */
	public List<Valuable> reParseAndEvaluate() throws LexicalException, SyntaxException {
		lexicalAnalysis();
		return evaluate();
	}
